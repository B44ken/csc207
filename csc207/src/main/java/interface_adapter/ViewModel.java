...
public class ViewModel<T> {
    ...
    // having properties of observable, called through PropertyChangeSupport rather than having to extend Observable.
    // variable listens, rather than this class having to KNOW
    ...
    // above: property has changed: send message to all listeners
